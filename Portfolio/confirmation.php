...
//    Save data to database
    ...
    echo "<a class='container text-center btn btn-dark' href='http://jigama.greenriverdev.com/305/Portfolio/guestbook.php' role='button'>Return back to guest form</a>";
